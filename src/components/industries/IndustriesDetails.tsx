...
const industries = [
  ...
  { icon: Leaf, name: "Cannabis", id: "cannabis", image: cannabisImg, description: "Our team's expertise help cannabis organizations navigate complex regulatory requirements, optimize supply chain management, and enhance customer engagement through innovative technologies and tailored IT services.", link: "View All Services & Solutions For The Cannabis Industry", items: [] },
